...
#xwb-peer0
#rm deployed/xwb-peer0/channel-artifacts/* -rf
#cp channel-artifacts/* deployed/xwb-peer0/channel-artifacts/ -r
rm deployed/xwb-peer0/mymsp/localmsp/* -rf
cp crypto-config/peerOrganizations/xwb.csxoa.cn/peers/peer0.xwb.csxoa.cn/* deployed/xwb-peer0/mymsp/localmsp/ -r
#xwb-peer1
#rm deployed/xwb-peer1/channel-artifacts/* -rf
#cp channel-artifacts/* deployed/xwb-peer1/channel-artifacts/ -r
rm deployed/xwb-peer1/mymsp/localmsp/* -rf
cp crypto-config/peerOrganizations/xwb.csxoa.cn/peers/peer1.xwb.csxoa.cn/* deployed/xwb-peer1/mymsp/localmsp/ -r
...
cp crypto-config/peerOrganizations/xwb.csxoa.cn/users/Admin@xwb.csxoa.cn deployed/client/mymsp/localmsp/ -r
...
mkdir -p deployed/client/mymsp/orgmsp/xwb.csxoa.cn
cp crypto-config/peerOrganizations/xwb.csxoa.cn/msp deployed/client/mymsp/orgmsp/xwb.csxoa.cn/ -r
